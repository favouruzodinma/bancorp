                        ...
                        <div class="iq-card-body p-0">
                           <div class="iq-edit-list">
                              <ul class="iq-edit-profile d-flex nav nav-pills">
                                 ...
                                 <li class="col-md-3 p-0">
                                    <a class="nav-link active"  href="change-pwd">
                                       Change Password
                                    </a>
                                 </li>
                                 <li class="col-md-3 p-0">
                     ...
                     <div class="iq-edit-list-data">
                        <div class="tab-content">
                            <div class="iq-card">
                                ...
                                <form method="POST" action="include/process/change-password.php">
                                    <input type="hidden" name="userid" value="<?php echo $userid ?>">
                                    <div class="form-group">
                                        <label for="cpass">Current Password:</label>
                                        <!-- <a href="javascripe:void();" class="float-right">Forgot Password</a> -->
                                            <input type="Password" class="form-control" id="cpass" name="password" value="" required>
                                        </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="vpass">Verify Password:</label>
                                            <input type="Password" class="form-control" id="vpass" name="vpassword" value="" required>
                                    </div>
                                    <button type="submit" class="btn btn-primary mr-2" name="change_pass">Submit</button>
                                </form>
                                </div>
                            </div>
                        </div>
