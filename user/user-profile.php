                              ...
                              <div class="profile-info p-4">
                                       ...
                                       <div class="user-detail pl-5">
                                          <div class="d-flex flex-wrap align-items-center">
                                             <div class="profile-img pr-4">
                                                ...
                                                <img src="../profile/<?php echo $row['profile_img'] ?>" class="avatar-100 img-fluid" alt="user">
                                                <?php }else{ ?>
                                             ...
                                             <div class="profile-detail d-flex align-items-start" >
                                                <h6 style="font-weight: 900;"><?php echo $row['account_number'] ?></h6>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                       <div class="user-detail pl-5">
                                          <div class="d-flex flex-wrap align-items-center">
                                             <div class="profile-detail d-flex align-items-center" style="flex-direction: column;">
                                                <small>Account Balance</small>
                                                <h6 style="font-weight:900"><?php echo $row['currency'] ?> <?php echo number_format($row['main_balance'], 2); ?></h6>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-sm-12 col-md-6">
                                        <div class="profile-detail d-flex align-items-center" style="flex-direction: column;">
                                          ...
                                          <h6 style="font-weight:900"><?php echo $row['currency'] ?> <?php echo number_format($row['overdraft_balance'], 2); ?></h6>
                                       </div>
                                    </div>
                                 </div>
                              </div>
